...
/**
 * Client for the HTML to PDF API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://htmltopdf.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/htmltopdf';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\HtmltopdfClient] {$message}\n";
        }
    }
}
