...
```gradle
dependencies {
    implementation 'com.github.apiverve:htmltopdf-api:1.1.12'
}
```
...
HTMLtoPDFAPIClient client = new HTMLtoPDFAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/htmltopdf](https://docs.apiverve.com/ref/htmltopdf)
...
- **Documentation:** [https://docs.apiverve.com/ref/htmltopdf](https://docs.apiverve.com/ref/htmltopdf)
- **Issues:** [GitHub Issues](https://github.com/apiverve/htmltopdf-api/issues)
