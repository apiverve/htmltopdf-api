...
//
//     HTMLtoPDFData data = Converter.fromJsonString(jsonString);

package com.apiverve.htmltopdf.data;
...
public class Converter {
    ...
    public static HTMLtoPDFData fromJsonString(String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    public static String toJsonString(HTMLtoPDFData obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.readerFor(HTMLtoPDFData.class);
        writer = mapper.writerFor(HTMLtoPDFData.class);
    }
