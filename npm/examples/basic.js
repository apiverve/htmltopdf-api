/**
 * Basic Example - HTML to PDF API
 *
 * This example demonstrates how to use the HTML to PDF API.
 * Make sure to set your API key in the .env file or replace '[YOUR_API_KEY]' below.
 */

require('dotenv').config();
const htmltopdfAPI = require('../index.js');
...
console.log('Making request to HTML to PDF API...\n');
